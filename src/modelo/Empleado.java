    ...
    public boolean crearFileXML(LinkedList<Empleado> listaEmpleados) {
        ...
        try {
            ...
            for (int i = 0; i < listaEmpleados.size(); i++) {
                ...
                empleado.addContent(new Element("edad").setText(String.valueOf(listaEmpleados.get(i).getCodigoEmpleado())));
                empleado.addContent(new Element("Codigo").setText(listaEmpleados.get(i).getDepartamento()));
